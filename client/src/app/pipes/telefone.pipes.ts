...
export class TelefonePipe implements PipeTransform {
    transform(value: string): string {
        ...
        if (valorFormatado.length === 1) {
            valorFormatado = valorFormatado.replace(/(\d{1})/,'($1');
            ...
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{3})/,'($1)$2');
        } else if (valorFormatado.length === 6) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{4})/,'($1)$2-');
        } else if (valorFormatado.length === 7) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{4})(\d{1})/,'($1)$2-$3');
        } else if (valorFormatado.length === 8) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{4})(\d{2})/,'($1)$2-$3');
        } else if (valorFormatado.length === 9) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{4})(\d{3})/,'($1)$2-$3');
        } else if (valorFormatado.length === 10) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{4})(\d{4})/,'($1)$2-$3');
        } else if (valorFormatado.length === 11) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{5})(\d{4})/,'($1)$2-$3');
        } else if (valorFormatado.length > 11) {
            valorFormatado = valorFormatado.replace(/(\d{2})(\d{5})(\d{4})/,'($1)$2-$3');
        }
